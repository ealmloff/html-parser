    ...
    fn new_parser() -> impl kalosm_sample::SendCreateParserState<Output = Self> {
        ...
        LiteralParser::new("\"accesskey\"=")
            ...
            .or(LiteralParser::new("\"type\"=")
                .ignore_output_then(crate::LtValues::new_parser())
...
impl kalosm_sample::Parse for Ol {
    fn new_parser() -> impl kalosm_sample::SendCreateParserState<Output = Self> {
        ...
        LiteralParser::new("<ol")
            .ignore_output_then(
                LiteralParser::new(" ")
                    .ignore_output_then(OlAttributes::new_parser())
                    .repeat(0..=10000),
            )
            .then_literal(">")
