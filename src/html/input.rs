...
pub enum InputAttributes {
    ...
    Autofocus(crate::// Could not find value set
String),
    Checked(crate::// Could not find value set
String),
    Class(crate::String),
    Contenteditable(crate::String),
    Contextmenu(crate::String),
    Dir(crate::DValues),
    Dirname(crate::String),
    Disabled(crate::// Could not find value set
String),
    Draggable(crate::BValues),
    Dropzone(crate::String),
    Exportparts(crate::String),
    Form(crate::String),
    Formaction(crate::String),
    Formenctype(crate::EtValues),
    Formmethod(crate::FmValues),
    Formnovalidate(crate::// Could not find value set
String),
    Formtarget(crate::String),
    Height(crate::String),
...
String),
    ...
    List(crate::String),
    Max(crate::String),
    Maxlength(crate::String),
    Min(crate::String),
    Minlength(crate::String),
    Multiple(crate::// Could not find value set
String),
    Name(crate::String),
    ...
    Part(crate::String),
    Pattern(crate::String),
    Placeholder(crate::String),
    Readonly(crate::// Could not find value set
String),
    Required(crate::// Could not find value set
String),
