...
impl kalosm_sample::Parse for BodyAttributes {
    fn new_parser() -> impl kalosm_sample::SendCreateParserState<Output = Self> {
        ...
        LiteralParser::new("\"accesskey\"=")
            ...
            .or(LiteralParser::new("\"background\"=")
                .ignore_output_then(String::new_parser())
                .map_output(|value| Self::Background(value)))
            .or(LiteralParser::new("\"bgcolor\"=")
                .ignore_output_then(String::new_parser())
                .map_output(|value| Self::Bgcolor(value)))
            .or(LiteralParser::new("\"bottommargin\"=")
                .ignore_output_then(String::new_parser())
            ...
            .or(LiteralParser::new("\"onhashchange\"=")
                .ignore_output_then(String::new_parser())
            ...
            .or(LiteralParser::new("\"onlanguagechange\"=")
                .ignore_output_then(String::new_parser())
            ...
            .or(LiteralParser::new("\"onmessage\"=")
                .ignore_output_then(String::new_parser())
            ...
            .or(LiteralParser::new("\"onoffline\"=")
                .ignore_output_then(String::new_parser())
                .map_output(|value| Self::Onoffline(value)))
            .or(LiteralParser::new("\"ononline\"=")
                .ignore_output_then(String::new_parser())
                .map_output(|value| Self::Ononline(value)))
            .or(LiteralParser::new("\"onpagehide\"=")
                .ignore_output_then(String::new_parser())
                .map_output(|value| Self::Onpagehide(value)))
            .or(LiteralParser::new("\"onpageshow\"=")
                .ignore_output_then(String::new_parser())
            ...
            .or(LiteralParser::new("\"onpopstate\"=")
                .ignore_output_then(String::new_parser())
            ...
            .or(LiteralParser::new("\"onstorage\"=")
                .ignore_output_then(String::new_parser())
            ...
            .or(LiteralParser::new("\"onundo\"=")
                .ignore_output_then(String::new_parser())
                .map_output(|value| Self::Onundo(value)))
            .or(LiteralParser::new("\"onunload\"=")
                .ignore_output_then(String::new_parser())
            ...
            .or(LiteralParser::new("\"rightmargin\"=")
                .ignore_output_then(String::new_parser())
...
impl kalosm_sample::Parse for Body {
    fn new_parser() -> impl kalosm_sample::SendCreateParserState<Output = Self> {
        ...
        LiteralParser::new("<body")
            .ignore_output_then(
                LiteralParser::new(" ")
                    .ignore_output_then(BodyAttributes::new_parser())
                    .repeat(0..=10000),
            )
            .then_literal(">")
