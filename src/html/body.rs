...
pub enum BodyAttributes {
    ...
    Background(crate::String),
    Bgcolor(crate::String),
    Bottommargin(crate::String),
    Class(crate::String),
...
String),
    ...
    Lang(crate::String),
    Leftmargin(crate::String),
    Link(crate::String),
    Onabort(crate::String),
    Onafterprint(crate::String),
    Onbeforeprint(crate::String),
    Onbeforeunload(crate::String),
    Onblur(crate::String),
    ...
    Onoffline(crate::String),
    Ononline(crate::String),
    Onpagehide(crate::String),
    Onpageshow(crate::String),
