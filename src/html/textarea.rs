...
impl kalosm_sample::Parse for TextareaAttributes {
    fn new_parser() -> impl kalosm_sample::SendCreateParserState<Output = Self> {
        ...
        LiteralParser::new("\"accesskey\"=")
            ...
            .or(LiteralParser::new("\"wrap\"=")
                .ignore_output_then(crate::WValues::new_parser())
...
impl kalosm_sample::Parse for Textarea {
    fn new_parser() -> impl kalosm_sample::SendCreateParserState<Output = Self> {
        ...
        LiteralParser::new("<textarea")
            .ignore_output_then(
                LiteralParser::new(" ")
                    .ignore_output_then(TextareaAttributes::new_parser())
                    .repeat(0..=10000),
            )
            .then_literal(">")
