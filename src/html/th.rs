...
impl kalosm_sample::Parse for Th {
    fn new_parser() -> impl kalosm_sample::SendCreateParserState<Output = Self> {
        ...
        LiteralParser::new("<th")
            .ignore_output_then(
                LiteralParser::new(" ")
                    .ignore_output_then(ThAttributes::new_parser())
                    .repeat(0..=10000),
            )
            .then_literal(">")
