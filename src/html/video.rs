...
pub enum VideoAttributes {
    ...
    Autoplay(crate::// Could not find value set
String),
    Class(crate::String),
    Contenteditable(crate::String),
    Contextmenu(crate::String),
    Controls(crate::// Could not find value set
String),
...
String),
    ...
    Lang(crate::String),
    Loop(crate::// Could not find value set
String),
    Mediagroup(crate::String),
    Muted(crate::// Could not find value set
String),
