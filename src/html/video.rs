...
impl kalosm_sample::Parse for VideoAttributes {
    fn new_parser() -> impl kalosm_sample::SendCreateParserState<Output = Self> {
        ...
        LiteralParser::new("\"accesskey\"=")
            ...
            .or(LiteralParser::new("\"loop\"=")
                .ignore_output_then(String::new_parser())
                .map_output(|value| Self::Loop(value)))
            .or(LiteralParser::new("\"mediagroup\"=")
                .ignore_output_then(String::new_parser())
                .map_output(|value| Self::Mediagroup(value)))
            .or(LiteralParser::new("\"muted\"=")
                .ignore_output_then(String::new_parser())
            ...
            .or(LiteralParser::new("\"poster\"=")
                .ignore_output_then(String::new_parser())
                .map_output(|value| Self::Poster(value)))
            .or(LiteralParser::new("\"preload\"=")
                .ignore_output_then(crate::PlValues::new_parser())
...
impl kalosm_sample::Parse for Video {
    fn new_parser() -> impl kalosm_sample::SendCreateParserState<Output = Self> {
        ...
        LiteralParser::new("<video")
            .ignore_output_then(
                LiteralParser::new(" ")
                    .ignore_output_then(VideoAttributes::new_parser())
                    .repeat(0..=10000),
            )
            .then_literal(">")
