...
impl kalosm_sample::Parse for TrackAttributes {
    fn new_parser() -> impl kalosm_sample::SendCreateParserState<Output = Self> {
        ...
        LiteralParser::new("\"accesskey\"=")
            ...
            .or(LiteralParser::new("\"kind\"=")
                .ignore_output_then(crate::TkValues::new_parser())
                .map_output(|value| Self::Kind(value)))
            .or(LiteralParser::new("\"label\"=")
                .ignore_output_then(String::new_parser())
...
impl kalosm_sample::Parse for Track {
    fn new_parser() -> impl kalosm_sample::SendCreateParserState<Output = Self> {
        ...
        LiteralParser::new("<track")
            .ignore_output_then(
                LiteralParser::new(" ")
                    .ignore_output_then(TrackAttributes::new_parser())
                    .repeat(0..=10000),
            )
            .then_literal(">")
