...
pub enum ObjectAttributes {
    ...
    Border(crate::String),
    Class(crate::String),
    Classid(crate::String),
    Codebase(crate::String),
    Codetype(crate::String),
    Contenteditable(crate::String),
    Contextmenu(crate::String),
    Data(crate::String),
    Declare(crate::String),
    Dir(crate::DValues),
...
String),
    ...
    Standby(crate::String),
    Style(crate::String),
    Tabindex(crate::String),
    Title(crate::String),
    Translate(crate::YValues),
    Type(crate::String),
    Typemustmatch(crate::// Could not find value set
String),
    Usemap(crate::String),
    Width(crate::String),
}
