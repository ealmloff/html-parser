...
pub enum IframeAttributes {
    ...
    Allow(crate::String),
    Allowfullscreen(crate::// Could not find value set
String),
    Allowpaymentrequest(crate::String),
...
String),
    ...
    Part(crate::String),
    Referrerpolicy(crate::String),
    Role(crate::RolesValues),
    Sandbox(crate::SbValues),
    Seamless(crate::// Could not find value set
String),
    Slot(crate::String),
