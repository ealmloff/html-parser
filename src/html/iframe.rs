...
impl kalosm_sample::Parse for IframeAttributes {
    fn new_parser() -> impl kalosm_sample::SendCreateParserState<Output = Self> {
        ...
        LiteralParser::new("\"accesskey\"=")
            ...
            .or(LiteralParser::new("\"allow\"=")
                .ignore_output_then(String::new_parser())
                .map_output(|value| Self::Allow(value)))
            .or(LiteralParser::new("\"allowfullscreen\"=")
                .ignore_output_then(String::new_parser())
                .map_output(|value| Self::Allowfullscreen(value)))
            .or(LiteralParser::new("\"allowpaymentrequest\"=")
                .ignore_output_then(String::new_parser())
            ...
            .or(LiteralParser::new("\"sandbox\"=")
                .ignore_output_then(crate::SbValues::new_parser())
                .map_output(|value| Self::Sandbox(value)))
            .or(LiteralParser::new("\"seamless\"=")
                .ignore_output_then(String::new_parser())
...
impl kalosm_sample::Parse for Iframe {
    fn new_parser() -> impl kalosm_sample::SendCreateParserState<Output = Self> {
        ...
        LiteralParser::new("<iframe")
            .ignore_output_then(
                LiteralParser::new(" ")
                    .ignore_output_then(IframeAttributes::new_parser())
                    .repeat(0..=10000),
            )
            .then_literal(">")
